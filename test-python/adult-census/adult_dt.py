...
if __name__ == "__main__":
    spark = SparkSession.builder.appName("AdultCensusDecisionTree").getOrCreate()
    ...
    # Decision Tree Model
    dt = DecisionTreeClassifier(labelCol="income_index", featuresCol="features", maxBins=50)  # maxBins adjusted as earlier

    # Pipeline
    pipeline = Pipeline(stages=indexers + [assembler, labelIndexer, dt])
