...
if __name__ == "__main__":
    spark = SparkSession.builder.appName("AdultCensusRandomForest").getOrCreate()
    ...
    # Random Forest Model
    rf = RandomForestClassifier(labelCol="income_index", featuresCol="features", numTrees=10, maxBins=50)  # Adjust maxBins to handle max categories
